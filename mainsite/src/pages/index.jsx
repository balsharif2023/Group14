        ...
        <aside className="left-sidebar">
          ...
          <div>
            <div className="brand-logo d-flex align-items-center justify-content-between">
              <a href="./index.js" className="text-nowrap logo-img">
                <img
            ...
            <nav className="sidebar-nav scroll-sidebar" data-simplebar="">
              <ul id="sidebarnav">
                ...
                <li className="sidebar-item">
                  <a
                    className="sidebar-link"
                    href="./authentication-register.js"
                    aria-expanded="false"
                  >
                    <span>
                ...
                <div className="card overflow-hidden rounded-2">
                  <div className="position-relative">
                    <a href="javascript:void(0)">
                      <img
                        src="../../public/images/products/s4.jpg"
              ...
              <div className="col-sm-6 col-xl-3">
                <div className="card overflow-hidden rounded-2">
                  <div className="position-relative">
                    <a href="javascript:void(0)">
                      <img
                        src="../../public/images/products/s5.jpg"
                        className="card-img-top rounded-0"
                        alt="..."
                      />
                    </a>
              ...
              <div className="col-sm-6 col-xl-3">
                <div className="card overflow-hidden rounded-2">
                  <div className="position-relative">
                    <a href="javascript:void(0)">
                      <img
                        src="../../public/images/products/s7.jpg"
                        className="card-img-top rounded-0"
                        alt="..."
                      />
                    </a>
              ...
              <div className="col-sm-6 col-xl-3">
                <div className="card overflow-hidden rounded-2">
                  <div className="position-relative">
                    <a href="javascript:void(0)">
                      <img
                        src="../../public/images/products/s11.jpg"
                        className="card-img-top rounded-0"
                        alt="..."
                      />
                    </a>
